...
public class DefenseWeaponB : MonoBehaviour
{
    ...
    {
        GameObject.Instantiate(Bullet, BulletStartPosRight.position, BulletStartPosRight.rotation);
        GameObject.Instantiate(Bullet, BulletStartPosLift.position, BulletStartPosLift.rotation);
        yield return null;
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///-----------------------------------------当たり判定処理-----------------------------------------------------///
